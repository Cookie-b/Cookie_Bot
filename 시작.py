...
async def on_ready():
    ...
    await bot.change_presence(status=discord.Status.online, activity=discord.Game("밥먹기"))
...
async def 재생(ctx, *, msg):
    if not vc.is_playing():
        ...
        chromedriver_dir = r"C:\Users\jslov\Desktop\디스코드봇 파이썬\chromedriver.exe"
...
bot.run('ODM5ODk2ODgwMDk5NjIyOTMy.YJQU7A.QmRMpppat9nTgcUIerINlxjx9W0')